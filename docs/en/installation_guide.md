...
>
1. Download and decompress the OpenCV source code package based on the version mapping. Copy the OpenCV source code package [`opencv-4.10.0.zip`](https://github.com/opencv/opencv/archive/refs/tags/4.10.0.zip) to the `/home` directory and decompress it.
...
2. Download the files in this repository to the `/home` directory.
...
4. Apply the optimization patch.
...
6. Check whether OpenCV is installed.

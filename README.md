...
| OpenCV版本   | 特性变更    |
| ------------ | ------------ |
|   4.10.0    |   新增`erode`、`Canny`、`HoughLines`、`HoughCircles`、`norm`、`mean`、`determinant`、`completeSymm`、`eigen`、`moments`、`minAreaRect`、`connectedComponents`、`connectedComponentsWithStats`、`minMaxLoc`、`warpPerspective`、`rotate`、`perspectiveTransform`、`transform` 函数

...
| -------- | -------- |-------------- | ------------------------------------------------------------ |
| 1.0.1   | 10.3.1   |4.10.0         | https://github.com/opencv/opencv/archive/refs/tags/4.10.0.zip |

## 环境部署
鲲鹏OpenCV的环境部署详见[鲲鹏OpenCV环境部署指南](https://gitcode.com/boostkit/opencv/blob/master/docs/zh/deploy.md)。


## 快速入门
以mean函数为例，求图像各通道的平均值。详见[快速入门](https://gitcode.com/boostkit/opencv/blob/master/docs/zh/quick_start.md)。
...
本项目采用Apache License Version 2.0许可证。详见[LICENSE](https://gitcode.com/boostkit/opencv/blob/master/LICENSE)文件。
